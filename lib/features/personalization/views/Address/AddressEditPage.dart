      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(child: TextFieldWidget(hintText: 'Street', icon: Iconsax.home, label: 'Street',validator: (p0) => p0!.isEmpty ? 'address error' : null, )),
                SizedBox(
                  width: 10.w,
                ),
                Expanded(child: TextFieldWidget(hintText: 'Post Code', icon: Iconsax.location, label: 'Post Code',validator: (p0) => p0!.isEmpty ? 'city error' : null, )),
            ...
            TextFieldWidget(hintText: 'Country', icon: Iconsax.call, label: 'Country',validator: (p0) => p0!.isEmpty ? 'phone error' : null, ),
          SizedBox(
                  height: 20.h,
                ),
